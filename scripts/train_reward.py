#!/usr/bin/env python3
"""Reward model training script for Kolmogorov."""
...
from kolmogorov.trainers import RewardTrainerWrapper
...
def main():
    ...
    try:
        ...
        logger.warning("No test split found, skipping evaluation dataset")
    
    logger.info("Initializing Reward Model trainer...")
    trainer = RewardTrainerWrapper(
        config=config,
